<gfcare-mm-system-user-screen :team-id="{{ $team->id }}" inline-template>
    ...
    @include('MobileMidwife::system.add-user')
    @include('MobileMidwife::system.edit-user')

</gfcare-mm-system-user-screen>
