Vue.component('gfcare-mm-system-user-screen', {
    ...
    methods: {
        ...
        addNewUser: function () {
            var self = this;
            Spark.post('/gfcare/mobile-midwife/system/users', this.forms.addUser)
                .then(function () {
        ...
        updateUser: function () {
            var self = this;
            Spark.put('/gfcare/mobile-midwife/system/users/' + this.editingUser.id, this.forms.updateUser)
                .then(function () {
        ...
        removeUser: function (user) {
            ...
            this.$http.delete('/gfcare/mobile-midwife/system/users/' + user.id)
                .success(function () {
