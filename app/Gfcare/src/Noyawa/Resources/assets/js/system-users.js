Vue.component('gfcare-noyawa-system-user-screen', {
    ...
    methods: {
        ...
        addNewUser: function () {
            var self = this;
            Spark.post('/gfcare/noyawa/system/users', this.forms.addUser)
                .then(function () {
        ...
        updateUser: function () {
            var self = this;
            Spark.put('/gfcare/noyawa/system/users/' + this.editingUser.id, this.forms.updateUser)
                .then(function () {
        ...
        removeUser: function (user) {
            ...
            this.$http.delete('/gfcare/noyawa/system/users/' + user.id)
                .success(function () {
