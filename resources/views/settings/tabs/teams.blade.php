...
<spark-settings-teams-screen inline-template>
    <div id="spark-settings-teams-screen">
        <!-- Create Team -->
        <div class="panel panel-default" v-if="user && user.user_type=='Super Admin'">
            ...
            <div class="panel-body">
                <table class="table table-responsive">
                    ...
                    <tr v-for="team in teams">
                        ...
                        <td>
                            <a href="{{ url('/settings/teams/') }}/@{{ team.id }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header" v-if="teamToDelete">
                        ...
                        <h4 class="modal-title"><i class="fa fa-btn fa-times"></i>Delete Project (@{{ teamToDelete.name }})
                        </h4>
                    </div>

                    <div class="modal-body">
                        <p>
                            Are you sure you want to delete this project? The project and all of its
