<spark-team-settings-user-screen inline-template>
    ...
    @include('settings.team.tabs.user.add-user')
    @include('settings.team.tabs.user.edit-user')

</spark-team-settings-user-screen>
