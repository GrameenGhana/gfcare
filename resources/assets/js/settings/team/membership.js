Vue.component('spark-team-settings-membership-screen', {
    ...
    methods: {
        ...
        sendInvite: function () {
            ...
            Spark.post('/gfcare/settings/teams/' + this.team.id + '/invitations', this.forms.sendInvite)
                .then(function () {
        ...
        cancelInvite: function (invite) {
            ...
            this.$http.delete('/gfcare/settings/teams/' + this.team.id + '/invitations/' + invite.id)
                .success(function () {
        ...
        removeTeamMember: function (teamMember) {
            ...
            this.$http.delete('/gfcare/settings/teams/' + this.team.id + '/members/' + teamMember.id)
                .success(function () {
                    this.$dispatch('updateTeam');
                });
        },
        ...
        leaveTeam: function () {
            ...
            this.$http.delete('/gfcare/settings/teams/' + this.team.id + '/membership')
                .success(function () {
                    window.location = '/gfcare/settings?tab=teams';
                });
        },
