...
Vue.component('spark-settings-subscription-screen', {
    ...
    methods: {
         ...
         */
        getCoupon: function () {
            this.$http.get('api/subscriptions/user/coupon')
        ...
        sendSubscription: function () {
            ...
            Spark.post('/gfcare/settings/user/plan', this.forms.subscribe)
                .then(function () {
        ...
        changePlan: function () {
            ...
            Spark.put('/gfcare/settings/user/plan', this.forms.changePlan)
                .then(function () {
                    self.$dispatch('updateUser');
        ...
        updateCardUsingToken: function (token) {
            this.$http.put('/gfcare/settings/user/card', {stripe_token: token})
                .success(function () {
        ...
        updateExtraBillingInfo: function () {
            Spark.put('/gfcare/settings/user/vat', this.forms.extraBillingInfo);
        },
        ...
        cancelSubscription: function () {
            ...
            Spark.delete('/gfcare/settings/user/plan', this.forms.cancelSubscription)
                .then(function () {
                    self.$dispatch('updateUser');
        ...
        resumeSubscription: function () {
            ...
            Spark.post('/gfcare/settings/user/plan/resume', this.forms.resumeSubscription)
                .then(function () {
                    self.$dispatch('updateUser');
                });
        },
