Vue.component('spark-settings-teams-screen', {
    ...
    methods: {
        ...
        getInvitations: function () {
            this.$http.get('/gfcare/api/teams/invitations')
        ...
        createTeam: function () {
            ...
            Spark.post('/gfcare/settings/teams', this.forms.createTeam)
                .then(function () {
        ...
        leaveTeam: function (team) {
            ...
            this.$http.delete('/gfcare/settings/teams/' + team.id + '/membership')
                .success(function () {
        ...
        deleteTeam: function () {
            ...
            Spark.delete('/gfcare/settings/teams/' + this.teamToDelete.id, this.forms.deleteTeam)
                .then(function () {
        ...
        acceptInvite: function (invite) {
            ...
            this.$http.post('/gfcare/settings/teams/invitations/' + invite.id + '/accept')
                .success(function () {
                    this.$dispatch('updateUser');
                    this.$dispatch('updateTeams');
                });
        ...
        rejectInvite: function (invite) {
            ...
            this.$http.delete('/gfcare/settings/teams/invitations/' + invite.id);
        },
