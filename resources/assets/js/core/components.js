...
require('./../settings/team/module');
require('./../settings/team/location')
require('./../settings/team/location/add-team-location')
require('./../settings/team/location/edit-team-location')
require('./../settings/team/location/manage-team-facility')
