Vue.component('spark-subscription-register-screen', {
    ...
    methods: {
         ...
         */
        getPlans: function () {
            this.$http.get('gfcare/api/subscriptions/plans')
        ...
        getCoupon: function (coupon) {
            this.$http.get('gfcare/api/subscriptions/coupon/' + coupon)
        ...
        getInvitation: function (invitation) {
            this.$http.get('/gfcare/api/teams/invitation/' + invitation)
        ...
        sendRegistration: function () {
            ...
            this.$http.post('/gfcare/register', this.forms.registration)
                .success(function (response) {
                    window.location = '/gfcare/home';
                })
                .error(function (errors) {
